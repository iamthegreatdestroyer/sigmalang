...
from sigmalang.core.encoder import SigmaDecoder, SigmaEncoder, SigmaHashBank  # noqa: E402
from sigmalang.core.parser import SemanticParser, SemanticTreePrinter  # noqa: E402
...
from sigmalang.ryot_integration import RyotInputProcessor, SigmaLangPipeline, create_pipeline  # noqa: E402
from sigmalang.training.codebook import (  # noqa: E402
    CodebookTrainer,
    LearnedCodebook,
    PatternExtractor,
    TrainingConfig,
...
class TestPipeline(unittest.TestCase):
    ...
    def test_pattern_learning(self):
        ...
        for _ in range(20):
            self.pipeline.encode_input(text)
