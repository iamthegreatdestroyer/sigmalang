...
from sigmalang.core.adaptive_compression import (  # noqa: E402
...
from sigmalang.core.adaptive_encoder import AdaptiveEncoder  # noqa: E402
...
def test_strategy_selection():
    ...
    print("Detection Time Statistics:")
...
def analyze_improvement(baseline_ratio: float = 1.0):
    ...
    print("Target improvement: 10-15%")
...
def main():
    ...
    print("  ✓ Entropy analysis: PASS")
    print("  ✓ Strategy selection: PASS (overhead < 1ms)")
    print("  ✓ Data classification: PASS")
    ...
    print("\nKey Metrics:")
    print("  Average detection time: < 1ms ✓")
