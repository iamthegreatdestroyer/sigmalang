...
class TestIntegration:
    ...
    def test_full_workflow(self):
        ...
        # Encode texts
        ml.encode("cat", Language.ENGLISH)
        ml.encode("gato", Language.SPANISH)
    ...
    def test_alignment_improves_similarity(self):
        ...
        # Both should be valid similarities (cosine can be negative)
        assert -1 <= sim_before <= 1
        assert -1 <= sim_after <= 1
