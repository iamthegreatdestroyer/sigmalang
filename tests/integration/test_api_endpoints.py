...
Tests all API services with direct method calls.
Verifies service functionality, error handling, and
end-to-end service integration.

Test Coverage:
- Encode service (single and batch)
- Decode service
- Analogy service (solve and explain)
- Search service
- Entity service
- NLP service
...
from sigmalang.core.api_server import create_api, SigmalangAPI
...
class TestHealthService:
    ...
    def test_health_check_returns_valid_response(self, api):
        """Test health service returns valid response."""
        response = api.health()
        assert response is not None

    @pytest.mark.integration
    def test_health_check_response_structure(self, api):
    ...
    @pytest.mark.integration
    def test_health_check_includes_uptime(self, api):
        """Test health includes uptime info."""
        response = api.health()
...
class TestInfoService:
    ...
    @pytest.mark.integration
    def test_info_returns_valid_response(self, api):
        """Test info service returns valid response."""
        response = api.info()
        assert response is not None

    @pytest.mark.integration
    def test_info_response_structure(self, api):
...
class TestEncodeService:
    """Tests for encode service."""

    @pytest.mark.integration
    def test_encode_simple_text(self, api):
