...
def main():
    ...
    print("Current Configuration (from encoder.py):")
    print("  Pool Size: 32, Buffer Size: 4096 bytes")
    ...
    print("  Target: 25% memory reduction")
    ...
    print("  pool_size = max(16, min(128, estimated_glyphs // 8))")
    print("  Rationale: Smaller pools save memory, larger pools avoid overflow")
    print("  Dynamic sizing based on tree node count")
