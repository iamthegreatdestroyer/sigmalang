...
class TestRateLimiter:
    ...
    def test_leaky_bucket_strategy(self):
        ...
        # Use very low leak rate to ensure bucket fills before leaking
        limiter = RateLimiter(
            requests_per_second=0.1,  # Very slow leak rate
            burst_size=2,
        ...
        # Third request should fail immediately since bucket is full
        with pytest.raises(RateLimitExceededError):
            limiter.acquire()
...
class TestBulkhead:
    ...
    def test_concurrent_access(self):
        ...
        bulkhead = Bulkhead("test", max_concurrent=5, timeout=5.0)  # Long timeout
        ...
        # All should eventually succeed because we use timeout
