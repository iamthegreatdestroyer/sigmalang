...
**Domain Contribution:** Data Streaming - streaming encoder/decoder, chunked compression, backpressure

**ΣLANG-Specific Tasks:**
- Streaming encoder/decoder, chunked compression, backpressure
