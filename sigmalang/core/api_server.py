...
# Core imports
from .config import FeatureFlags, SigmalangConfig, get_config
...
class DecoderService:
    ...
    def initialize(self) -> None:
        ...
        try:
            from .encoder import SigmaDecoder, SigmaEncoder
...
class NLPService:
    ...
    def initialize(self) -> None:
        ...
        try:
            from .transformer_embeddings import EmbeddingConfig, TransformerEmbeddings
