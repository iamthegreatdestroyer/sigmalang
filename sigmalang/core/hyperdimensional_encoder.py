...
class HyperdimensionalAlphabet:
    ...
    def from_primitives(
        ...
        for i, primitive in enumerate(primitives):
            ...
            prim_seed = int(hashlib.md5(primitive.encode(), usedforsecurity=False).hexdigest(), 16) % (2**32)
...
class HyperdimensionalSemanticEncoder:
    ...
    def encode_value(self, value: str) -> HyperVector:
        ...
        """
        value_seed = int(hashlib.md5(value.encode(), usedforsecurity=False).hexdigest(), 16) % (2**32)
