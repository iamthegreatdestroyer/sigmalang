...
from sigmalang.core.streaming_encoder import estimate_memory_usage, get_optimal_chunk_size, get_streaming_vs_full_memory
...
print("  ✅ 1GB file: ~1000MB (full-load) vs ~16MB (streaming) = 62.5x reduction!")
print("  ✅ Memory independent of file size - O(chunk_size) guarantees")
